...
def parse_args():
    ...
    parser.add_argument('-i', '--init', default='', help='Initial prompt key (default: )')
    ...
    return args, all(not v for v in vars(args).values() if isinstance(v, list) or isinstance(v, str))